!(function () {
	...
	var e = {
			9: function (e, t, n) {
				var r = n(81),
					...
					a = n(645),
					i = n.n(a)()(o());
				i.push([e.id, '.canvasDrawing{background-color:var(--color-primary)}', '']), (t.Z = i);
			},
			645: function (e) {
						...
						(t.i = function (e, n, r, o, a) {
							...
							for (var s = 0; s < e.length; s++) {
								...
								(r && i[f[0]]) ||
									...
									n &&
										(f[2]
											? ((f[1] = '@media '.concat(f[2], ' {').concat(f[1], '}')), (f[2] = n))
											: (f[2] = n)),
									o &&
										(f[4]
	...
	!(function () {
		...
		t()(v.Z, m);
		var y = v.Z && v.Z.locals ? v.Z.locals : void 0;
	})(),
		(module.exports['map-builder-canvas'] = r);
})();
